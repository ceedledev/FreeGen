<?php 
    ...
    if(empty($code)){
        ...
        $dedipass = file_get_contents('http://api.dedipass.com/v1/pay/?public_key=3d3dd4076c7ac444541d9368a788bdd7&private_key=a74368cfbcca94bef617342e488494195c4&code=' . $code);
        ...
        if($dedipass->status == 'success') {
            ...
            $resultat['content'] = "Le code ".$code." à été utilisé pour un montant d'une valeur de ".$dedipass->payout." EUR pour le grade STARTER";

            $now = date("Y-m-d H:i:s");
            $add = strtotime('+7 days');
            ...
            $insert->execute(array($utilisateur['id'], "STARTER", $dedipass->payout, $code, $now));
